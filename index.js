...
//         // If not connected to the internet, display error image and prompt user to check network settings
//         // error.classList.add("active");
//         alert("Device is not connected to the internet. Please check your network connection settings.");
//         return;
//     }
